...
pub mod atom {
    ...
    use super::{Classification, Composition, definition::Definition, Dimension, function_set::FunctionSet, Property, UcumSymbol};
    use composable::Composable;
    use term::Term;

    lazy_static! {
        static ref METER: Definition = Definition { value: 1.0, terms: vec![Term::new(None, None)], function_set: None };
        static ref SECOND: Definition = Definition { value: 1.0, terms: vec![Term::new(None, None)], function_set: None };
        static ref GRAM: Definition = Definition { value: 1.0, terms: vec![Term::new(None, None)], function_set: None };
        static ref RADIAN: Definition = Definition { value: 1.0, terms: vec![Term::new(None, None)], function_set: None };
        static ref KELVIN: Definition = Definition { value: 1.0, terms: vec![Term::new(None, None)], function_set: None };
        static ref COULOMB: Definition = Definition { value: 1.0, terms: vec![Term::new(None, None)], function_set: None };
        static ref CANDELA: Definition = Definition { value: 1.0, terms: vec![Term::new(None, None)], function_set: None };
        static ref THE_NUMBER_TEN_FOR_ARBITRARY_POWERS_STAR: Definition = Definition::new(10.0, "1", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref THE_NUMBER_TEN_FOR_ARBITRARY_POWERS_CARET: Definition = Definition::new(10.0, "1", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref THE_NUMBER_PI: Definition = Definition::new(::std::f64::consts::PI, "1", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PERCENT: Definition = Definition::new(1.0, "10*-2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PARTS_PER_THOUSAND: Definition = Definition::new(1.0, "10*-3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PARTS_PER_MILLION: Definition = Definition::new(1.0, "10*-6", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PARTS_PER_BILLION: Definition = Definition::new(1.0, "10*-9", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PARTS_PER_TRILLION: Definition = Definition::new(1.0, "10*-12", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MOLE: Definition = Definition::new(6.0221367, "10*23", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref STERADIAN: Definition = Definition::new(1.0, "rad2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HERTZ: Definition = Definition::new(1.0, "s-1", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref NEWTON: Definition = Definition::new(1.0, "kg.m/s2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PASCAL: Definition = Definition::new(1.0, "N/m2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref JOULE: Definition = Definition::new(1.0, "N.m", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref WATT: Definition = Definition::new(1.0, "J/s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref AMPERE: Definition = Definition::new(1.0, "C/s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref VOLT: Definition = Definition::new(1.0, "J/C", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FARAD: Definition = Definition::new(1.0, "C/V", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref OHM: Definition = Definition::new(1.0, "V/A", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SIEMENS: Definition = Definition::new(1.0, "Ohm-1", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref WEBER: Definition = Definition::new(1.0, "V.s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DEGREE_CELSIUS: Definition = Definition::new(1.0, "K", Some(FunctionSet { convert_from: |value: f64| value - 273.15, convert_to: |value: f64| value + 273.15 })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref TESLA: Definition = Definition::new(1.0, "Wb/m2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HENRY: Definition = Definition::new(1.0, "Wb/A", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LUMEN: Definition = Definition::new(1.0, "cd.sr", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LUX: Definition = Definition::new(1.0, "lm/m2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BECQUEREL: Definition = Definition::new(1.0, "s-1", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GRAY: Definition = Definition::new(1.0, "J/kg", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SIEVERT: Definition = Definition::new(1.0, "J/kg", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GON: Definition = Definition::new(0.9, "deg", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DEGREE: Definition = Definition::new(2.0, "[pi].rad/360", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MINUTE_ANGLE: Definition = Definition::new(1.0, "deg/60", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SECOND_ANGLE: Definition = Definition::new(1.0, "'/60", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LITER: Definition = Definition::new(1.0, "dm3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LITER_SECONDARY: Definition = Definition::new(1.0, "l", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ARE: Definition = Definition::new(100.0, "m2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MINUTE: Definition = Definition::new(60.0, "s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HOUR: Definition = Definition::new(60.0, "min", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DAY: Definition = Definition::new(24.0, "h", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref TROPICAL_YEAR: Definition = Definition::new(365.24219, "d", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MEAN_JULIAN_YEAR: Definition = Definition::new(365.25, "d", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MEAN_GREGORIAN_YEAR: Definition = Definition::new(365.2425, "d", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref YEAR: Definition = Definition::new(1.0, "a_j", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref WEEK: Definition = Definition::new(7.0, "d", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SYNODAL_MONTH: Definition = Definition::new(29.53059, "d", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MEAN_JULIAN_MONTH: Definition = Definition::new(1.0, "a_j/12", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MEAN_GREGORIAN_MONTH: Definition = Definition::new(1.0, "a_g/12", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MONTH: Definition = Definition::new(1.0, "mo_j", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref TONNE: Definition = Definition::new(1000.0, "kg", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BAR: Definition = Definition::new(100000.0, "Pa", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref UNIFIED_ATOMIC_MASS_UNIT: Definition = Definition::new(0.0000000000000000000000016605402, "g", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ELECTRONVOLT: Definition = Definition::new(1.0, "[e].V", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ASTRONOMIC_UNIT: Definition = Definition::new(149597.870691, "Mm", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PARSEC: Definition = Definition::new(30856780000000000.0, "m", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref VELOCITY_OF_LIGHT: Definition = Definition::new(299792458.0, "m/s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PLANCK_CONSTANT: Definition = Definition::new(0.00000000000000000000000000000000066260755, "J.s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BOLTZMANN_CONSTANT: Definition = Definition::new(0.00000000000000000000001380658, "J/K", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PERMITTIVITY_OF_VACUUM: Definition = Definition::new(0.000000000008854187817, "F/m", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PERMEABILITY_OF_VACUUM: Definition = Definition::new(1.0, "4.[pi].10*-7.N/A2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ELEMENTARY_CHARGE: Definition = Definition::new(0.000000000000000000160217733, "C", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ELECTRON_MASS: Definition = Definition::new(0.00000000000000000000000000091093897, "g", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PROTON_MASS: Definition = Definition::new(0.0000000000000000000000016726231, "g", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref NEWTONIAN_CONSTANT_OF_GRAVITATION: Definition = Definition::new(0.0000000000667259, "m3.kg-1.s-2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref STANDARD_ACCELERATION_OF_FREE_FALL: Definition = Definition::new(9.80665, "m/s2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref STANDARD_ATMOSPHERE: Definition = Definition::new(101325.0, "Pa", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LIGHT_YEAR: Definition = Definition::new(1.0, "[c].a_j", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GRAM_FORCE: Definition = Definition::new(1.0, "g.[g]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref POUND_FORCE_AVOIRDUPOIS: Definition = Definition::new(1.0, "[lb_av].[g]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref KAYSER: Definition = Definition::new(1.0, "cm-1", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GAL: Definition = Definition::new(1.0, "cm/s2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DYNE: Definition = Definition::new(1.0, "g.cm/s2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ERG: Definition = Definition::new(1.0, "dyn.cm", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref POISE: Definition = Definition::new(1.0, "dyn.s/cm2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BIOT: Definition = Definition::new(10.0, "A", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref STOKES: Definition = Definition::new(1.0, "cm2/s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MAXWELL: Definition = Definition::new(0.00000001, "Wb", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GAUSS: Definition = Definition::new(0.0001, "T", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref OERSTED: Definition = Definition::new(250.0, "/[pi].A/m", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GILBERT: Definition = Definition::new(1.0, "Oe.cm", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref STILB: Definition = Definition::new(1.0, "cd/cm2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LAMBERT: Definition = Definition::new(1.0, "cd/cm2/[pi]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PHOT: Definition = Definition::new(0.0001, "lx", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CURIE: Definition = Definition::new(37000000000.0, "Bq", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ROENTGEN: Definition = Definition::new(0.000258, "C/kg", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref RADIATION_ABSORBED_DOSE: Definition = Definition::new(100.0, "erg/g", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref RADIATION_EQUIVALENT_MAN: Definition = Definition::new(1.0, "RAD", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref INCH_INTERNATIONAL: Definition = Definition::new(2.54, "cm", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FOOT_INTERNATIONAL: Definition = Definition::new(12.0, "[in_i]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref YARD_INTERNATIONAL: Definition = Definition::new(3.0, "[ft_i]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MILE_INTERNATIONAL: Definition = Definition::new(5280.0, "[ft_i]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FATHOM_INTERNATIONAL: Definition = Definition::new(6.0, "[ft_i]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref NAUTICAL_MILE_INTERNATIONAL: Definition = Definition::new(1852.0, "m", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref KNOT_INTERNATIONAL: Definition = Definition::new(1.0, "[nmi_i]/h", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SQUARE_INCH_INTERNATIONAL: Definition = Definition::new(1.0, "[in_i]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SQUARE_FOOT_INTERNATIONAL: Definition = Definition::new(1.0, "[ft_i]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SQUARE_YARD_INTERNATIONAL: Definition = Definition::new(1.0, "[yd_i]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CUBIC_INCH_INTERNATIONAL: Definition = Definition::new(1.0, "[in_i]3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CUBIC_FOOT_INTERNATIONAL: Definition = Definition::new(1.0, "[ft_i]3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CUBIC_YARD_INTERNATIONAL: Definition = Definition::new(1.0, "[yd_i]3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BOARD_FOOT_INTERNATIONAL: Definition = Definition::new(144.0, "[in_i]3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CORD_INTERNATIONAL: Definition = Definition::new(128.0, "[ft_i]3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MIL_INTERNATIONAL: Definition = Definition::new(0.001, "[in_i]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CIRCULAR_MIL_INTERNATIONAL: Definition = Definition::new(1.0, "[pi]/4.[mil_i]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HAND_INTERNATIONAL: Definition = Definition::new(4.0, "[in_i]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FOOT_US: Definition = Definition::new(1200.0, "m/3937", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref YARD_US: Definition = Definition::new(3.0, "[ft_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref INCH_US: Definition = Definition::new(1.0, "[ft_us]/12", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ROD_US: Definition = Definition::new(16.5, "[ft_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GUNTERS_CHAIN_US: Definition = Definition::new(4.0, "[rd_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LINK_FOR_GUNTERS_CHAIN_US: Definition = Definition::new(1.0, "[ch_us]/100", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref RAMDENS_CHAIN_US: Definition = Definition::new(100.0, "[ft_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LINK_FOR_RAMDENS_CHAIN_US: Definition = Definition::new(1.0, "[rch_us]/100", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FATHOM_US: Definition = Definition::new(6.0, "[ft_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FURLONG_US: Definition = Definition::new(40.0, "[rd_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MILE_US: Definition = Definition::new(8.0, "[fur_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ACRE_US: Definition = Definition::new(160.0, "[rd_us]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SQUARE_ROD_US: Definition = Definition::new(1.0, "[rd_us]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SQUARE_MILE_US: Definition = Definition::new(1.0, "[mi_us]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SECTION: Definition = Definition::new(1.0, "[mi_us]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref TOWNSHIP: Definition = Definition::new(36.0, "[sct]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MIL_US: Definition = Definition::new(0.001, "[in_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref INCH_BRITISH: Definition = Definition::new(2.539998, "cm", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FOOT_BRITISH: Definition = Definition::new(12.0, "[in_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ROD_BRITISH: Definition = Definition::new(16.5, "[ft_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GUNTERS_CHAIN_BRITISH: Definition = Definition::new(4.0, "[rd_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LINK_FOR_GUNTERS_CHAIN_BRITISH: Definition = Definition::new(1.0, "[ch_br]/100", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FATHOM_BRITISH: Definition = Definition::new(6.0, "[ft_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PACE_BRITISH: Definition = Definition::new(2.5, "[ft_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref YARD_BRITISH: Definition = Definition::new(3.0, "[ft_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MILE_BRITISH: Definition = Definition::new(5280.0, "[ft_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref NAUTICAL_MILE_BRITISH: Definition = Definition::new(6080.0, "[ft_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref KNOT_BRITISH: Definition = Definition::new(1.0, "[nmi_br]/h", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ACRE_BRITISH: Definition = Definition::new(4840.0, "[yd_br]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref QUEEN_ANNES_WINE_GALLON_US: Definition = Definition::new(231.0, "[in_i]3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BARREL_US: Definition = Definition::new(42.0, "[gal_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref QUART_US: Definition = Definition::new(1.0, "[gal_us]/4", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PINT_US: Definition = Definition::new(1.0, "[qt_us]/2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GILL_US: Definition = Definition::new(1.0, "[pt_us]/4", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FLUID_OUNCE_US: Definition = Definition::new(1.0, "[gil_us]/4", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FLUID_DRAM_US: Definition = Definition::new(1.0, "[foz_us]/8", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MINIM_US: Definition = Definition::new(1.0, "[fdr_us]/60", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CORD_US: Definition = Definition::new(128.0, "[ft_i]3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BUSHEL_US: Definition = Definition::new(2150.42, "[in_i]3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HISTORICAL_WINCHESTER_GALLON: Definition = Definition::new(1.0, "[bu_us]/8", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PECK_US: Definition = Definition::new(1.0, "[bu_us]/4", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DRY_QUART_US: Definition = Definition::new(1.0, "[pk_us]/8", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DRY_PINT_US: Definition = Definition::new(1.0, "[dqt_us]/2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref TABLESPOON_US: Definition = Definition::new(1.0, "[foz_us]/2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref TEASPOON_US: Definition = Definition::new(1.0, "[tbs_us]/3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CUP_US: Definition = Definition::new(16.0, "[tbs_us]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref METRIC_FLUID_OUNCE: Definition = Definition::new(30.0, "mL", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref METRIC_CUP: Definition = Definition::new(240.0, "mL", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref METRIC_TEASPOON: Definition = Definition::new(5.0, "mL", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref METRIC_TABLESPOON: Definition = Definition::new(15.0, "mL", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GALLON_BRITISH: Definition = Definition::new(4.54609, "l", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PECK_BRITISH: Definition = Definition::new(2.0, "[gal_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BUSHEL_BRITISH: Definition = Definition::new(4.0, "[pk_br]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref QUART_BRITISH: Definition = Definition::new(1.0, "[gal_br]/4", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PINT_BRITISH: Definition = Definition::new(1.0, "[qt_br]/2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GILL_BRITISH: Definition = Definition::new(1.0, "[pt_br]/4", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FLUID_OUNCE_BRITISH: Definition = Definition::new(1.0, "[gil_br]/5", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref FLUID_DRAM_BRITISH: Definition = Definition::new(1.0, "[foz_br]/8", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MINIM_BRITISH: Definition = Definition::new(1.0, "[fdr_br]/60", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GRAIN: Definition = Definition::new(64.79891, "mg", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref POUND_AVOIRDUPOIS: Definition = Definition::new(7000.0, "[gr]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref OUNCE_AVOIRDUPOIS: Definition = Definition::new(1.0, "[lb_av]/16", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DRAM_AVOIRDUPOIS: Definition = Definition::new(1.0, "[oz_av]/16", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SHORT_HUNDREDWEIGHT_AVOIRDUPOIS: Definition = Definition::new(100.0, "[lb_av]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LONG_HUNDERDWEIGHT_AVOIRDUPOIS: Definition = Definition::new(112.0, "[lb_av]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SHORT_TON_AVOIRDUPOIS: Definition = Definition::new(20.0, "[scwt_av]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LONG_TON_AVOIRDUPOIS: Definition = Definition::new(20.0, "[lcwt_av]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref STONE_AVOIRDUPOIS: Definition = Definition::new(14.0, "[lb_av]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PENNYWEIGHT_TROY: Definition = Definition::new(24.0, "[gr]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref OUNCE_TROY: Definition = Definition::new(20.0, "[pwt_tr]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref POUND_TROY: Definition = Definition::new(12.0, "[oz_tr]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SCRUPLE_APOTHECARIES: Definition = Definition::new(20.0, "[gr]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DRAM_APOTHECARIES: Definition = Definition::new(3.0, "[sc_ap]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref OUNCE_APOTHECARIES: Definition = Definition::new(8.0, "[dr_ap]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref POUND_APOTHECARIES: Definition = Definition::new(12.0, "[oz_ap]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref METRIC_OUNCE: Definition = Definition::new(28.0, "g", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LINE: Definition = Definition::new(1.0, "[in_i]/12", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref POINT: Definition = Definition::new(1.0, "[lne]/6", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PICA: Definition = Definition::new(12.0, "[pnt]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PRINTERS_POINT: Definition = Definition::new(0.013837, "[in_i]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PRINTERS_PICA: Definition = Definition::new(12.0, "[pnt_pr]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PIED: Definition = Definition::new(32.48, "cm", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref POUCE: Definition = Definition::new(1.0, "[pied]/12", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref LIGNE: Definition = Definition::new(1.0, "[pouce]/12", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DIDOT: Definition = Definition::new(1.0, "[ligne]/6", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CICERO: Definition = Definition::new(12.0, "[didot]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DEGREE_FAHRENHEIT: Definition = Definition::new(5.0, "K/9", Some(FunctionSet { convert_from: |value: f64| 9.0 * value / 5.0 - 459.67, convert_to: |value: f64| 5.0 / 9.0 * (value + 459.67) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DEGREE_RANKINE: Definition = Definition::new(5.0, "K/9", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DEGREE_REAUMUR: Definition = Definition::new(5.0, "K/4", Some(FunctionSet { convert_from: |value: f64| (value - 273.15) * 0.8, convert_to: |value: f64| (value / 0.8) + 273.15 })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CALORIE_AT15_C: Definition = Definition::new(4.1858, "J", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CALORIE_AT20_C: Definition = Definition::new(4.1819, "J", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MEAN_CALORIE: Definition = Definition::new(4.19002, "J", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref INTERNATIONAL_TABLE_CALORIE: Definition = Definition::new(4.1868, "J", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref THERMOCHEMICAL_CALORIE: Definition = Definition::new(4.184, "J", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CALORIE: Definition = Definition::new(1.0, "cal_th", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref NUTRITION_LABEL_CALORIES: Definition = Definition::new(1.0, "kcal_th", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BRITISH_THERMAL_UNIT_AT39_F: Definition = Definition::new(1.05967, "kJ", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BRITISH_THERMAL_UNIT_AT59_F: Definition = Definition::new(1.0548, "kJ", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BRITISH_THERMAL_UNIT_AT60_F: Definition = Definition::new(1.05468, "kJ", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MEAN_BRITISH_THERMAL_UNIT: Definition = Definition::new(1.05587, "kJ", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref INTERNATIONAL_TABLE_BRITISH_THERMAL_UNIT: Definition = Definition::new(1.05505585262, "kJ", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref THERMOCHEMICAL_BRITISH_THERMAL_UNIT: Definition = Definition::new(1.05435, "kJ", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BRITISH_THERMAL_UNIT: Definition = Definition::new(1.0, "[Btu_th]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HORSEPOWER: Definition = Definition::new(550.0, "[ft_i].[lbf_av]/s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref TEX: Definition = Definition::new(1.0, "g/km", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DENIER: Definition = Definition::new(1.0, "g/9/km", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref METER_OF_WATER_COLUMN: Definition = Definition::new(9.80665, "kPa", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref METER_OF_MERCURY_COLUMN: Definition = Definition::new(133.322, "kPa", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref INCH_OF_WATER_COLUMN: Definition = Definition::new(1.0, "m[H2O].[in_i]/m", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref INCH_OF_MERCURY_COLUMN: Definition = Definition::new(1.0, "m[Hg].[in_i]/m", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PERIPHERAL_VASCULAR_RESISTANCE_UNIT: Definition = Definition::new(1.0, "mm[Hg].s/ml", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref WOOD_UNIT: Definition = Definition::new(1.0, "mm[Hg].min/L", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DIOPTER: Definition = Definition::new(1.0, "/m", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PRISM_DIOPTER: Definition = Definition::new(1.0, "rad", Some(FunctionSet { convert_from: |value: f64| (value / 100.0).atan(), convert_to: |value: f64| value.tan() * 100.0 })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PERCENT_OF_SLOPE: Definition = Definition::new(1.0, "deg", Some(FunctionSet { convert_from: |value: f64| (value / 100.0).atan(), convert_to: |value: f64| value.tan() * 100.0 })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MESH_INTERNATIONAL: Definition = Definition::new(1.0, "/[in_i]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CHARRIERE: Definition = Definition::new(1.0, "mm/3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref DROP: Definition = Definition::new(1.0, "ml/20", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HOUNSFIELD_UNIT: Definition = Definition::default();
        static ref METABOLIC_EQUIVALENT: Definition = Definition::new(3.5, "mL/min/kg", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HOMEOPATHIC_POTENCY_OF_DECIMAL_SERIES_RETIRED: Definition = Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| -value.log10(), convert_to: |value: f64| 10_f64.powf(-value) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HOMEOPATHIC_POTENCY_OF_CENTESIMAL_SERIES_RETIRED: Definition = Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| -value.ln() / 100_f64.ln(), convert_to: |value: f64| 100_f64.powf(-value) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HOMEOPATHIC_POTENCY_OF_MILLESIMAL_SERIES_RETIRED: Definition = Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| -value.ln() / 1_000_f64.ln(), convert_to: |value: f64| 1_000_f64.powf(-value) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HOMEOPATHIC_POTENCY_OF_QUINTAMILLESIMAL_SERIES_RETIRED: Definition = Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| -value.ln() / 50_000_f64.ln(), convert_to: |value: f64| 50_000_f64.powf(-value) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HOMEOPATHIC_POTENCY_OF_DECIMAL_HAHNEMANNIAN_SERIES: Definition = Definition::default();
        static ref HOMEOPATHIC_POTENCY_OF_CENTESIMAL_HAHNEMANNIAN_SERIES: Definition = Definition::default();
        static ref HOMEOPATHIC_POTENCY_OF_MILLESIMAL_HAHNEMANNIAN_SERIES: Definition = Definition::default();
        static ref HOMEOPATHIC_POTENCY_OF_QUINTAMILLESIMAL_HAHNEMANNIAN_SERIES: Definition = Definition::default();
        static ref HOMEOPATHIC_POTENCY_OF_DECIMAL_KORSAKOVIAN_SERIES: Definition = Definition::default();
        static ref HOMEOPATHIC_POTENCY_OF_CENTESIMAL_KORSAKOVIAN_SERIES: Definition = Definition::default();
        static ref HOMEOPATHIC_POTENCY_OF_MILLESIMAL_KORSAKOVIAN_SERIES: Definition = Definition::default();
        static ref HOMEOPATHIC_POTENCY_OF_QUINTAMILLESIMAL_KORSAKOVIAN_SERIES: Definition = Definition::default();
        static ref EQUIVALENTS: Definition = Definition::new(1.0, "mol", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref OSMOLE: Definition = Definition::new(1.0, "mol", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref PH: Definition = Definition::new(1.0, "mol/l", Some(FunctionSet { convert_from: |value: f64| 10.0_f64.powf(-value), convert_to: |value: f64| -value.log10() })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref GRAM_PERCENT: Definition = Definition::new(1.0, "g/dl", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SVEDBERG_UNIT: Definition = Definition::new(1.0, "10*-13.s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref HIGH_POWER_FIELD: Definition = Definition::default();
        static ref LOW_POWER_FIELD: Definition = Definition::new(100.0, "1", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref KATAL: Definition = Definition::new(1.0, "mol/s", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref UNIT: Definition = Definition::new(1.0, "umol/min", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref INTERNATIONAL_UNIT: Definition = Definition::default();
        static ref INTERNATIONAL_UNIT_SECONDARY: Definition = Definition::new(1.0, "[iU]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ARBITARY_UNIT: Definition = Definition::default();
        static ref UNITED_STATES_PHARMACOPEIA_UNIT: Definition = Definition::default();
        static ref GPL_UNIT: Definition = Definition::default();
        static ref MPL_UNIT: Definition = Definition::default();
        static ref APL_UNIT: Definition = Definition::default();
        static ref BETHESDA_UNIT: Definition = Definition::default();
        static ref ANTI_FACTOR_XA_UNIT: Definition = Definition::default();
        static ref TODD_UNIT: Definition = Definition::default();
        static ref DYE_UNIT: Definition = Definition::default();
        static ref SOMOGYI_UNIT: Definition = Definition::default();
        static ref BODANSKY_UNIT: Definition = Definition::default();
        static ref KING_ARMSTRONG_UNIT: Definition = Definition::default();
        static ref KUNKEL_UNIT: Definition = Definition::default();
        static ref MAC_LAGAN_UNIT: Definition = Definition::default();
        static ref TUBERCULIN_UNIT: Definition = Definition::default();
        static ref CELL_CULTURE_INFECTIOUS_DOSE: Definition = Definition::default();
        static ref TISSUE_CULTURE_INFECTIOUS_DOSE: Definition = Definition::default();
        static ref EMBRYO_INFECTIOUS_DOSE: Definition = Definition::default();
        static ref PLAQUE_FORMING_UNITS: Definition = Definition::default();
        static ref FOCUS_FORMING_UNITS: Definition = Definition::default();
        static ref COLONY_FORMING_UNITS: Definition = Definition::default();
        static ref INDEX_OF_REACTIVITY: Definition = Definition::default();
        static ref BIOEQUIVALENT_ALLERGEN_UNIT: Definition = Definition::default();
        static ref ALLERGEN_UNIT: Definition = Definition::default();
        static ref ALLERGEN_UNIT_FOR_AMBROSIA_ARTEMISIIFOLIA: Definition = Definition::default();
        static ref PROTEIN_NITROGEN_UNIT: Definition = Definition::default();
        static ref LIMIT_OF_FLOCCULATION: Definition = Definition::default();
        static ref D_ANTIGEN_UNIT: Definition = Definition::default();
        static ref FIBRINOGEN_EQUIVALENT_UNIT: Definition = Definition::default();
        static ref ELISA_UNIT: Definition = Definition::default();
        static ref EHRLICH_UNIT: Definition = Definition::default();
        static ref NEPER: Definition = Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| value.ln(), convert_to: |value: f64| ::std::f64::consts::E.powf(value) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BEL: Definition = Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| value.log10(), convert_to: |value: f64| 10_f64.powf(value) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BEL_SOUND_PRESSURE: Definition = Definition::new(2.0, "10*-5.Pa", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BEL_VOLT: Definition = Definition::new(1.0, "V", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BEL_MILLIVOLT: Definition = Definition::new(1.0, "mV", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BEL_MICROVOLT: Definition = Definition::new(1.0, "uV", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BEL10_NANOVOLT: Definition = Definition::new(10.0, "nV", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BEL_WATT: Definition = Definition::new(1.0, "W", Some(FunctionSet { convert_from: |value: f64| value.log10(), convert_to: |value: f64| 10_f64.powf(value) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BEL_KILOWATT: Definition = Definition::new(1.0, "kW", Some(FunctionSet { convert_from: |value: f64| value.log10(), convert_to: |value: f64| 10_f64.powf(value) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref STERE: Definition = Definition::new(1.0, "m3", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref ANGSTROM: Definition = Definition::new(0.1, "nm", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BARN: Definition = Definition::new(100.0, "fm2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref TECHNICAL_ATMOSPHERE: Definition = Definition::new(1.0, "kgf/cm2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref MHO: Definition = Definition::new(1.0, "S", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref POUND_PER_SQARE_INCH: Definition = Definition::new(1.0, "[lbf_av]/[in_i]2", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CIRCLE: Definition = Definition::new(2.0, "[pi].rad", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SPERE: Definition = Definition::new(4.0, "[pi].sr", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref METRIC_CARAT: Definition = Definition::new(0.2, "g", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref CARAT_OF_GOLD_ALLOYS: Definition = Definition::new(1.0, "/24", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref SMOOT: Definition = Definition::new(67.0, "[in_i]", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref METER_PER_SQUARE_SECONDS_PER_SQUARE_ROOT_OF_HERTZ: Definition = Definition::new(1.0, "m2/s4/Hz", Some(FunctionSet { convert_from: |value: f64| value.sqrt(), convert_to: |value: f64| value.powi(2) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BIT_LOGARITHMUS_DUALIS: Definition = Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| value.log2(), convert_to: |value: f64| 2_f64.powf(value) })).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BIT: Definition = Definition::default();
        static ref BYTE: Definition = Definition::new(8.0, "bit", None).expect("BUG! Bad Atom -> Definition mapping!");
        static ref BAUD: Definition = Definition::new(1.0, "/s", None).expect("BUG! Bad Atom -> Definition mapping!");
    }
    ...
    impl Atom {
         pub(crate) fn definition(&self) -> &Definition {
            match *self {
                ...
                Atom::Radian => &*RADIAN,
                Atom::Kelvin => &*KELVIN,
                Atom::Coulomb => &*COULOMB,
                Atom::Candela => &*CANDELA,
                Atom::TheNumberTenForArbitraryPowersStar => &*THE_NUMBER_TEN_FOR_ARBITRARY_POWERS_STAR,
                Atom::TheNumberTenForArbitraryPowersCaret => &*THE_NUMBER_TEN_FOR_ARBITRARY_POWERS_CARET,
                Atom::TheNumberPi => &*THE_NUMBER_PI,
                Atom::Percent => &*PERCENT,
                Atom::PartsPerThousand => &*PARTS_PER_THOUSAND,
                Atom::PartsPerMillion => &*PARTS_PER_MILLION,
                Atom::PartsPerBillion => &*PARTS_PER_BILLION,
                Atom::PartsPerTrillion => &*PARTS_PER_TRILLION,
                Atom::Mole => &*MOLE,
                Atom::Steradian => &*STERADIAN,
                Atom::Hertz => &*HERTZ,
                Atom::Newton => &*NEWTON,
                Atom::Pascal => &*PASCAL,
                Atom::Joule => &*JOULE,
                ...
                Atom::Farad => &*FARAD,
                Atom::Ohm => &*OHM,
                Atom::Siemens => &*SIEMENS,
                Atom::Weber => &*WEBER,
                Atom::DegreeCelsius => &*DEGREE_CELSIUS,
                Atom::Tesla => &*TESLA,
                Atom::Henry => &*HENRY,
                Atom::Lumen => &*LUMEN,
                Atom::Lux => &*LUX,
                Atom::Becquerel => &*BECQUEREL,
                Atom::Gray => &*GRAY,
                Atom::Sievert => &*SIEVERT,
                Atom::Gon => &*GON,
                Atom::Degree => &*DEGREE,
                Atom::MinuteAngle => &*MINUTE_ANGLE,
                Atom::SecondAngle => &*SECOND_ANGLE,
                Atom::Liter => &*LITER,
                Atom::LiterSecondary => &*LITER_SECONDARY,
                Atom::Are => &*ARE,
                Atom::Minute => &*MINUTE,
                Atom::Hour => &*HOUR,
                Atom::Day => &*DAY,
                Atom::TropicalYear => &*TROPICAL_YEAR,
                Atom::MeanJulianYear => &*MEAN_JULIAN_YEAR,
                Atom::MeanGregorianYear => &*MEAN_GREGORIAN_YEAR,
                Atom::Year => &*YEAR,
                Atom::Week => &*WEEK,
                Atom::SynodalMonth => &*SYNODAL_MONTH,
                Atom::MeanJulianMonth => &*MEAN_JULIAN_MONTH,
                Atom::MeanGregorianMonth => &*MEAN_GREGORIAN_MONTH,
                Atom::Month => &*MONTH,
                Atom::Tonne => &*TONNE,
                Atom::Bar => &*BAR,
                Atom::UnifiedAtomicMassUnit => &*UNIFIED_ATOMIC_MASS_UNIT,
                Atom::Electronvolt => &*ELECTRONVOLT,
                Atom::AstronomicUnit => &*ASTRONOMIC_UNIT,
                Atom::Parsec => &*PARSEC,
                Atom::VelocityOfLight => &*VELOCITY_OF_LIGHT,
                Atom::PlanckConstant => &*PLANCK_CONSTANT,
                Atom::BoltzmannConstant => &*BOLTZMANN_CONSTANT,
                Atom::PermittivityOfVacuum => &*PERMITTIVITY_OF_VACUUM,
                Atom::PermeabilityOfVacuum => &*PERMEABILITY_OF_VACUUM,
                Atom::ElementaryCharge => &*ELEMENTARY_CHARGE,
                Atom::ElectronMass => &*ELECTRON_MASS,
                Atom::ProtonMass => &*PROTON_MASS,
                Atom::NewtonianConstantOfGravitation => &*NEWTONIAN_CONSTANT_OF_GRAVITATION,
                Atom::StandardAccelerationOfFreeFall => &*STANDARD_ACCELERATION_OF_FREE_FALL,
                Atom::StandardAtmosphere => &*STANDARD_ATMOSPHERE,
                Atom::LightYear => &*LIGHT_YEAR,
                Atom::GramForce => &*GRAM_FORCE,
                Atom::PoundForceAvoirdupois => &*POUND_FORCE_AVOIRDUPOIS,
                Atom::Kayser => &*KAYSER,
                Atom::Gal => &*GAL,
                Atom::Dyne => &*DYNE,
                Atom::Erg => &*ERG,
                ...
                Atom::Biot => &*BIOT,
                Atom::Stokes => &*STOKES,
                Atom::Maxwell => &*MAXWELL,
                Atom::Gauss => &*GAUSS,
                Atom::Oersted => &*OERSTED,
                Atom::Gilbert => &*GILBERT,
                Atom::Stilb => &*STILB,
                Atom::Lambert => &*LAMBERT,
                Atom::Phot => &*PHOT,
                Atom::Curie => &*CURIE,
                Atom::Roentgen => &*ROENTGEN,
                Atom::RadiationAbsorbedDose => &*RADIATION_ABSORBED_DOSE,
                Atom::RadiationEquivalentMan => &*RADIATION_EQUIVALENT_MAN,
                Atom::InchInternational => &*INCH_INTERNATIONAL,
                Atom::FootInternational => &*FOOT_INTERNATIONAL,
                Atom::YardInternational => &*YARD_INTERNATIONAL,
                Atom::MileInternational => &*MILE_INTERNATIONAL,
                Atom::FathomInternational => &*FATHOM_INTERNATIONAL,
                Atom::NauticalMileInternational => &*NAUTICAL_MILE_INTERNATIONAL,
                Atom::KnotInternational => &*KNOT_INTERNATIONAL,
                Atom::SquareInchInternational => &*SQUARE_INCH_INTERNATIONAL,
                Atom::SquareFootInternational => &*SQUARE_FOOT_INTERNATIONAL,
                Atom::SquareYardInternational => &*SQUARE_YARD_INTERNATIONAL,
                Atom::CubicInchInternational => &*CUBIC_INCH_INTERNATIONAL,
                Atom::CubicFootInternational => &*CUBIC_FOOT_INTERNATIONAL,
                Atom::CubicYardInternational => &*CUBIC_YARD_INTERNATIONAL,
                Atom::BoardFootInternational => &*BOARD_FOOT_INTERNATIONAL,
                Atom::CordInternational => &*CORD_INTERNATIONAL,
                Atom::MilInternational => &*MIL_INTERNATIONAL,
                Atom::CircularMilInternational => &*CIRCULAR_MIL_INTERNATIONAL,
                Atom::HandInternational => &*HAND_INTERNATIONAL,
                Atom::FootUS => &*FOOT_US,
                Atom::YardUS => &*YARD_US,
                Atom::InchUS => &*INCH_US,
                Atom::RodUS => &*ROD_US,
                Atom::GuntersChainUS => &*GUNTERS_CHAIN_US,
                Atom::LinkForGuntersChainUS => &*LINK_FOR_GUNTERS_CHAIN_US,
                Atom::RamdensChainUS => &*RAMDENS_CHAIN_US,
                Atom::LinkForRamdensChainUS => &*LINK_FOR_RAMDENS_CHAIN_US,
                Atom::FathomUS => &*FATHOM_US,
                Atom::FurlongUS => &*FURLONG_US,
                Atom::MileUS => &*MILE_US,
                Atom::AcreUS => &*ACRE_US,
                Atom::SquareRodUS => &*SQUARE_ROD_US,
                Atom::SquareMileUS => &*SQUARE_MILE_US,
                Atom::Section => &*SECTION,
                Atom::Township => &*TOWNSHIP,
                Atom::MilUS => &*MIL_US,
                Atom::InchBritish => &*INCH_BRITISH,
                Atom::FootBritish => &*FOOT_BRITISH,
                Atom::RodBritish => &*ROD_BRITISH,
                Atom::GuntersChainBritish => &*GUNTERS_CHAIN_BRITISH,
                Atom::LinkForGuntersChainBritish => &*LINK_FOR_GUNTERS_CHAIN_BRITISH,
                Atom::FathomBritish => &*FATHOM_BRITISH,
                Atom::PaceBritish => &*PACE_BRITISH,
                Atom::YardBritish => &*YARD_BRITISH,
                Atom::MileBritish => &*MILE_BRITISH,
                Atom::NauticalMileBritish => &*NAUTICAL_MILE_BRITISH,
                Atom::KnotBritish => &*KNOT_BRITISH,
                Atom::AcreBritish => &*ACRE_BRITISH,
                Atom::QueenAnnesWineGallonUS => &*QUEEN_ANNES_WINE_GALLON_US,
                Atom::BarrelUS => &*BARREL_US,
                Atom::QuartUS => &*QUART_US,
                Atom::PintUS => &*PINT_US,
                Atom::GillUS => &*GILL_US,
                Atom::FluidOunceUS => &*FLUID_OUNCE_US,
                Atom::FluidDramUS => &*FLUID_DRAM_US,
                Atom::MinimUS => &*MINIM_US,
                Atom::CordUS => &*CORD_US,
                Atom::BushelUS => &*BUSHEL_US,
                Atom::HistoricalWinchesterGallon => &*HISTORICAL_WINCHESTER_GALLON,
                Atom::PeckUS => &*PECK_US,
                Atom::DryQuartUS => &*DRY_QUART_US,
                Atom::DryPintUS => &*DRY_PINT_US,
                Atom::TablespoonUS => &*TABLESPOON_US,
                Atom::TeaspoonUS => &*TEASPOON_US,
                Atom::CupUS => &*CUP_US,
                Atom::MetricFluidOunce => &*METRIC_FLUID_OUNCE,
                Atom::MetricCup => &*METRIC_CUP,
                Atom::MetricTeaspoon => &*METRIC_TEASPOON,
                Atom::MetricTablespoon => &*METRIC_TABLESPOON,
                Atom::GallonBritish => &*GALLON_BRITISH,
                Atom::PeckBritish => &*PECK_BRITISH,
                Atom::BushelBritish => &*BUSHEL_BRITISH,
                Atom::QuartBritish => &*QUART_BRITISH,
                Atom::PintBritish => &*PINT_BRITISH,
                Atom::GillBritish => &*GILL_BRITISH,
                Atom::FluidOunceBritish => &*FLUID_OUNCE_BRITISH,
                Atom::FluidDramBritish => &*FLUID_DRAM_BRITISH,
                Atom::MinimBritish => &*MINIM_BRITISH,
                Atom::Grain => &*GRAIN,
                Atom::PoundAvoirdupois => &*POUND_AVOIRDUPOIS,
                Atom::OunceAvoirdupois => &*OUNCE_AVOIRDUPOIS,
                Atom::DramAvoirdupois => &*DRAM_AVOIRDUPOIS,
                Atom::ShortHundredweightAvoirdupois => &*SHORT_HUNDREDWEIGHT_AVOIRDUPOIS,
                Atom::LongHunderdweightAvoirdupois => &*LONG_HUNDERDWEIGHT_AVOIRDUPOIS,
                Atom::ShortTonAvoirdupois => &*SHORT_TON_AVOIRDUPOIS,
                Atom::LongTonAvoirdupois => &*LONG_TON_AVOIRDUPOIS,
                Atom::StoneAvoirdupois => &*STONE_AVOIRDUPOIS,
                Atom::PennyweightTroy => &*PENNYWEIGHT_TROY,
                Atom::OunceTroy => &*OUNCE_TROY,
                Atom::PoundTroy => &*POUND_TROY,
                Atom::ScrupleApothecaries => &*SCRUPLE_APOTHECARIES,
                Atom::DramApothecaries => &*DRAM_APOTHECARIES,
                Atom::OunceApothecaries => &*OUNCE_APOTHECARIES,
                Atom::PoundApothecaries => &*POUND_APOTHECARIES,
                Atom::MetricOunce => &*METRIC_OUNCE,
                Atom::Line => &*LINE,
                Atom::Point => &*POINT,
                Atom::Pica => &*PICA,
                Atom::PrintersPoint => &*PRINTERS_POINT,
                Atom::PrintersPica => &*PRINTERS_PICA,
                Atom::Pied => &*PIED,
                Atom::Pouce => &*POUCE,
                Atom::Ligne => &*LIGNE,
                Atom::Didot => &*DIDOT,
                Atom::Cicero => &*CICERO,
                Atom::DegreeFahrenheit => &*DEGREE_FAHRENHEIT,
                Atom::DegreeRankine => &*DEGREE_RANKINE,
                Atom::DegreeReaumur => &*DEGREE_REAUMUR,
                Atom::CalorieAt15C => &*CALORIE_AT15_C,
                Atom::CalorieAt20C => &*CALORIE_AT20_C,
                Atom::MeanCalorie => &*MEAN_CALORIE,
                Atom::InternationalTableCalorie => &*INTERNATIONAL_TABLE_CALORIE,
                Atom::ThermochemicalCalorie => &*THERMOCHEMICAL_CALORIE,
                Atom::Calorie => &*CALORIE,
                Atom::NutritionLabelCalories => &*NUTRITION_LABEL_CALORIES,
                Atom::BritishThermalUnitAt39F => &*BRITISH_THERMAL_UNIT_AT39_F,
                Atom::BritishThermalUnitAt59F => &*BRITISH_THERMAL_UNIT_AT59_F,
                Atom::BritishThermalUnitAt60F => &*BRITISH_THERMAL_UNIT_AT60_F,
                Atom::MeanBritishThermalUnit => &*MEAN_BRITISH_THERMAL_UNIT,
                Atom::InternationalTableBritishThermalUnit => &*INTERNATIONAL_TABLE_BRITISH_THERMAL_UNIT,
                Atom::ThermochemicalBritishThermalUnit => &*THERMOCHEMICAL_BRITISH_THERMAL_UNIT,
                Atom::BritishThermalUnit => &*BRITISH_THERMAL_UNIT,
                Atom::Horsepower => &*HORSEPOWER,
                Atom::Tex => &*TEX,
                Atom::Denier => &*DENIER,
                Atom::MeterOfWaterColumn => &*METER_OF_WATER_COLUMN,
                Atom::MeterOfMercuryColumn => &*METER_OF_MERCURY_COLUMN,
                Atom::InchOfWaterColumn => &*INCH_OF_WATER_COLUMN,
                Atom::InchOfMercuryColumn => &*INCH_OF_MERCURY_COLUMN,
                Atom::PeripheralVascularResistanceUnit => &*PERIPHERAL_VASCULAR_RESISTANCE_UNIT,
                Atom::WoodUnit => &*WOOD_UNIT,
                Atom::Diopter => &*DIOPTER,
                Atom::PrismDiopter => &*PRISM_DIOPTER,
                Atom::PercentOfSlope => &*PERCENT_OF_SLOPE,
                Atom::MeshInternational => &*MESH_INTERNATIONAL,
                Atom::Charriere => &*CHARRIERE,
                Atom::Drop => &*DROP,
                Atom::HounsfieldUnit => &*HOUNSFIELD_UNIT,
                Atom::MetabolicEquivalent => &*METABOLIC_EQUIVALENT,
                Atom::HomeopathicPotencyOfDecimalSeriesRetired => &*HOMEOPATHIC_POTENCY_OF_DECIMAL_SERIES_RETIRED,
                Atom::HomeopathicPotencyOfCentesimalSeriesRetired => &*HOMEOPATHIC_POTENCY_OF_CENTESIMAL_SERIES_RETIRED,
                Atom::HomeopathicPotencyOfMillesimalSeriesRetired => &*HOMEOPATHIC_POTENCY_OF_MILLESIMAL_SERIES_RETIRED,
                Atom::HomeopathicPotencyOfQuintamillesimalSeriesRetired => &*HOMEOPATHIC_POTENCY_OF_QUINTAMILLESIMAL_SERIES_RETIRED,
                Atom::HomeopathicPotencyOfDecimalHahnemannianSeries => &*HOMEOPATHIC_POTENCY_OF_DECIMAL_HAHNEMANNIAN_SERIES,
                Atom::HomeopathicPotencyOfCentesimalHahnemannianSeries => &*HOMEOPATHIC_POTENCY_OF_CENTESIMAL_HAHNEMANNIAN_SERIES,
                Atom::HomeopathicPotencyOfMillesimalHahnemannianSeries => &*HOMEOPATHIC_POTENCY_OF_MILLESIMAL_HAHNEMANNIAN_SERIES,
                Atom::HomeopathicPotencyOfQuintamillesimalHahnemannianSeries => &*HOMEOPATHIC_POTENCY_OF_QUINTAMILLESIMAL_HAHNEMANNIAN_SERIES,
                Atom::HomeopathicPotencyOfDecimalKorsakovianSeries => &*HOMEOPATHIC_POTENCY_OF_DECIMAL_KORSAKOVIAN_SERIES,
                Atom::HomeopathicPotencyOfCentesimalKorsakovianSeries => &*HOMEOPATHIC_POTENCY_OF_CENTESIMAL_KORSAKOVIAN_SERIES,
                Atom::HomeopathicPotencyOfMillesimalKorsakovianSeries => &*HOMEOPATHIC_POTENCY_OF_MILLESIMAL_KORSAKOVIAN_SERIES,
                Atom::HomeopathicPotencyOfQuintamillesimalKorsakovianSeries => &*HOMEOPATHIC_POTENCY_OF_QUINTAMILLESIMAL_KORSAKOVIAN_SERIES,
                Atom::Equivalents => &*EQUIVALENTS,
                Atom::Osmole => &*OSMOLE,
                Atom::PH => &*PH,
                Atom::GramPercent => &*GRAM_PERCENT,
                Atom::SvedbergUnit => &*SVEDBERG_UNIT,
                Atom::HighPowerField => &*HIGH_POWER_FIELD,
                Atom::LowPowerField => &*LOW_POWER_FIELD,
                Atom::Katal => &*KATAL,
                Atom::Unit => &*UNIT,
                Atom::InternationalUnit => &*INTERNATIONAL_UNIT,
                Atom::InternationalUnitSecondary => &*INTERNATIONAL_UNIT_SECONDARY,
                Atom::ArbitaryUnit => &*ARBITARY_UNIT,
                Atom::UnitedStatesPharmacopeiaUnit => &*UNITED_STATES_PHARMACOPEIA_UNIT,
                Atom::GplUnit => &*GPL_UNIT,
                Atom::MplUnit => &*MPL_UNIT,
                Atom::AplUnit => &*APL_UNIT,
                Atom::BethesdaUnit => &*BETHESDA_UNIT,
                Atom::AntiFactorXaUnit => &*ANTI_FACTOR_XA_UNIT,
                Atom::ToddUnit => &*TODD_UNIT,
                Atom::DyeUnit => &*DYE_UNIT,
                Atom::SomogyiUnit => &*SOMOGYI_UNIT,
                Atom::BodanskyUnit => &*BODANSKY_UNIT,
                Atom::KingArmstrongUnit => &*KING_ARMSTRONG_UNIT,
                Atom::KunkelUnit => &*KUNKEL_UNIT,
                Atom::MacLaganUnit => &*MAC_LAGAN_UNIT,
                Atom::TuberculinUnit => &*TUBERCULIN_UNIT,
                Atom::CellCultureInfectiousDose => &*CELL_CULTURE_INFECTIOUS_DOSE,
                Atom::TissueCultureInfectiousDose => &*TISSUE_CULTURE_INFECTIOUS_DOSE,
                Atom::EmbryoInfectiousDose => &*EMBRYO_INFECTIOUS_DOSE,
                Atom::PlaqueFormingUnits => &*PLAQUE_FORMING_UNITS,
                Atom::FocusFormingUnits => &*FOCUS_FORMING_UNITS,
                Atom::ColonyFormingUnits => &*COLONY_FORMING_UNITS,
                Atom::IndexOfReactivity => &*INDEX_OF_REACTIVITY,
                Atom::BioequivalentAllergenUnit => &*BIOEQUIVALENT_ALLERGEN_UNIT,
                Atom::AllergenUnit => &*ALLERGEN_UNIT,
                Atom::AllergenUnitForAmbrosiaArtemisiifolia => &*ALLERGEN_UNIT_FOR_AMBROSIA_ARTEMISIIFOLIA,
                Atom::ProteinNitrogenUnit => &*PROTEIN_NITROGEN_UNIT,
                Atom::LimitOfFlocculation => &*LIMIT_OF_FLOCCULATION,
                Atom::DAntigenUnit => &*D_ANTIGEN_UNIT,
                Atom::FibrinogenEquivalentUnit => &*FIBRINOGEN_EQUIVALENT_UNIT,
                Atom::ElisaUnit => &*ELISA_UNIT,
                Atom::EhrlichUnit => &*EHRLICH_UNIT,
                Atom::Neper => &*NEPER,
                Atom::Bel => &*BEL,
                Atom::BelSoundPressure => &*BEL_SOUND_PRESSURE,
                Atom::BelVolt => &*BEL_VOLT,
                Atom::BelMillivolt => &*BEL_MILLIVOLT,
                Atom::BelMicrovolt => &*BEL_MICROVOLT,
                Atom::Bel10Nanovolt => &*BEL10_NANOVOLT,
                Atom::BelWatt => &*BEL_WATT,
                Atom::BelKilowatt => &*BEL_KILOWATT,
                Atom::Stere => &*STERE,
                Atom::Angstrom => &*ANGSTROM,
                Atom::Barn => &*BARN,
                Atom::TechnicalAtmosphere => &*TECHNICAL_ATMOSPHERE,
                Atom::Mho => &*MHO,
                Atom::PoundPerSqareInch => &*POUND_PER_SQARE_INCH,
                Atom::Circle => &*CIRCLE,
                Atom::Spere => &*SPERE,
                Atom::MetricCarat => &*METRIC_CARAT,
                Atom::CaratOfGoldAlloys => &*CARAT_OF_GOLD_ALLOYS,
                Atom::Smoot => &*SMOOT,
                Atom::MeterPerSquareSecondsPerSquareRootOfHertz => &*METER_PER_SQUARE_SECONDS_PER_SQUARE_ROOT_OF_HERTZ,
                Atom::BitLogarithmusDualis => &*BIT_LOGARITHMUS_DUALIS,
                Atom::Bit => &*BIT,
                Atom::Byte => &*BYTE,
                Atom::Baud => &*BAUD,
            }
    ...
    impl Composable for Atom {
        fn composition(&self) -> Composition {
            match *self {
                ...
                _ => {
                    let terms = self.definition().terms.as_slice();
                    terms.composition()
                },
            }
        }
